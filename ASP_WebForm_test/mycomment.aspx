...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <h1 class="alert alert-success">歡迎光臨，我的留言板</h1>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="處理" ShowHeader="False">
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Update" CssClass="btn btn-warning" Text="更新"></asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel" CssClass="btn btn-info" Text="取消"></asp:LinkButton>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Edit" CssClass="btn btn-warning" Text="編輯"></asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Delete" CssClass="btn btn-outline-danger" Text="刪除"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="created_time" DataFormatString="{0:yyyy/MM/dd HH:mm:ss}" HeaderText="時間" SortExpression="created_time" ReadOnly="True" />
                </Columns>
...
where A.author_id=B.uid and B.uid=@uid
order by A.id desc"
                DeleteCommand="DELETE FROM [comments] WHERE [id] = @id" UpdateCommand="UPDATE [comments] SET [comment] = @comment, [edited_time] = @edited_time WHERE [id] = @id">
                <DeleteParameters>
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="edited_time" Type="DateTime" />
                    <asp:Parameter Name="id" Type="Int32" />
                </UpdateParameters>
            </asp:SqlDataSource>
        </div>
